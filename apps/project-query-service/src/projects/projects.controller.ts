...
import { Access, AllExceptionFilter, Auth, Session } from '@taskapp/shared';
import {
  GetProjectDto,
  GetProjectsDto,
  ProjectResponseDto,
...
export class ProjectsController {
  ...
  async getAll(
    @Session('projectIds') allowedProjects,
  ...
  @Access()
  async getOne(@Param() { id }: GetProjectDto): Promise<ProjectResponseDto> {
