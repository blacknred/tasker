...
import { CreateAgentDto } from './dto/create-sprint.dto';
import { CreateInviteDto } from './dto/create-invite.dto';
import { GetAgentDto } from './dto/get-sprint.dto';
import { GetAgentsDto } from './dto/get-sprints.dto';
import { AgentResponseDto, AgentsResponseDto } from './dto/sprint-response.dto';
import { UpdateAgentDto } from './dto/update-sprint.dto';

@Controller()
@UseGuards(AgentGuard)
export class SprintsController {
  constructor(
    private readonly agentsService: SprintsService,
